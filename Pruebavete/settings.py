"""
Django settings for Pruebavete project.
...
SECRET_KEY = 'django-insecure-%w(6snz+!e^fnc-sp35^lr8+yu(%_(lp4gvw1nekj&s$kr6-cp'
...
WSGI_APPLICATION = 'Pruebavete.wsgi.application'
