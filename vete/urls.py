...
urlpatterns = [
    ...
    path('Empleado/delete/<int:pk>/<str:db>/', login_required(views.SupRegToDb)),
    ...
    path('Articulos/<int:pk>/delete/<str:db>/', login_required(views.SupRegToDb), name="Delete"),
    ...
    path('Proveedor/<int:pk>/delete/<str:db>/', login_required(views.SupRegToDb), name="Delete"),
    ...
    path('Cliente/<int:pk>/delete/<str:db>/', login_required(views.SupRegToDb), name="Delete"),
    ...
    path('Mascota/<int:pk>/delete/<str:db>/', login_required(views.SupRegToDb), name="Delete"),
